...
\bottomrule
\end{tabular}
\caption{Mallas usadas: parámetro de refinamiento $n$, número de incógnitas $M$ y
paso $h$. $n=3$ es el caso de inspección del Punto~1; $n=3,\dots,14$ el barrido de
error del Punto~2; $n=23$ el mayor resuelto en el Punto~3.}
\label{tab:malla}
\end{table}
