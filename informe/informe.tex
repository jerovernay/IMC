...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{../figuras/ejercicio2_a.png}
    \caption{Evolución en el espacio de fases ($\theta < 2\pi$).}
    \vspace{0.5cm} % Espacio opcional entre figuras
    \includegraphics[width=0.7\textwidth]{../figuras/ejercicio2_b.png}
    \caption{Evolución en el espacio de fases para $\theta_{\max} = 8\pi$.}
    \vspace{0.5cm}
    \includegraphics[width=0.5\textwidth]{../figuras/ejercicio2_c.png}
